...
class EthereumTransactions:
    ...
    def fetch_internal_transactions(self, address):
        total_fetched = 0
    ...
    def fetch_token_transactions(self, address):
        total_fetched = 0
    ...
    def fetch_nft_transactions(self, address):
        total_fetched = 0
